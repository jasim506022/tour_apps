...
import 'package:tour_apps/user/page/tourpage/tourdetailspage.dart';

class BookingTourWidget extends StatefulWidget {
  const BookingTourWidget({
    Key? key,
  }) : super(key: key);

  @override
  State<BookingTourWidget> createState() => _BookingTourWidgetState();
}

class _BookingTourWidgetState extends State<BookingTourWidget> {
  String? dateTime;
  ...
  void initState() {
    timer = Timer.periodic(Duration.zero, (timer) {
      // Inside the timer callback, recalculate the time difference
      var myData = Provider.of<TourModel>(context, listen: false);
