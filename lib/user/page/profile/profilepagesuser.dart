...
import 'package:tour_apps/user/page/booking/boookingsingletour.dart';
import 'package:tour_apps/user/page/profile/editprofilepageuser.dart';
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            EditProfilePageUser(isEditProfile: true),
                      ));
                },
                child: Container(
                  padding:
          ...
          ListTileWidget(
            ...
            fucntion: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const BookingTour(),
                  ));
            },
          ),
          ListTileWidget(
