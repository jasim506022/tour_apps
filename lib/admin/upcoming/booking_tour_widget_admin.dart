...
class BookingTourWidgetAdmin extends StatefulWidget {
  const BookingTourWidgetAdmin({
    Key? key,
    required this.uid,
  }) : super(key: key);
  final List<dynamic> uid;
  @override
  State<BookingTourWidgetAdmin> createState() => _BookingTourWidgetAdminState();
}

class _BookingTourWidgetAdminState extends State<BookingTourWidgetAdmin> {
  String? dateTime;
