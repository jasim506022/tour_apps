...
import 'groupdetailsadminpage.dart';

// ignore: must_be_immutable
class GroupTourAdminWidget extends StatelessWidget {
  const GroupTourAdminWidget({
    super.key,
  });
  @override
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  GroupDetailsAdminPage(model: grouptourModel),
            ));
      },
      child: Padding(
