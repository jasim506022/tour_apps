...
import 'package:tour_apps/admin/group/uploadgroupstrispadmin.dart';
...
class GroupTourDetailsScreen extends StatefulWidget {
  const GroupTourDetailsScreen({
    super.key,
    required this.model,
  });
  ...
  @override
  State<GroupTourDetailsScreen> createState() => _GroupTourDetailsScreenState();
}

class _GroupTourDetailsScreenState extends State<GroupTourDetailsScreen> {
  @override
  @override
              ...
              return PopupMenuButton(onSelected: (value) {
                ...
                if (values.getMenu == DeleteUpdate.delete) {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => UploadGroupTripsPageAdmin(
